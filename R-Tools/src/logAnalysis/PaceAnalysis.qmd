...
df_30Node_1 = "lowrate.30node.100sim.1-20 - 2025.12.03 22.39.47"
producePaceData(folder.30, df_30Node_1)
df_30Node_2 = "lowrate.30node.100sim.21-40 - 2025.12.03 22.39.51"
producePaceData(folder.30, df_30Node_2)
df_30Node_3 = "lowrate.30node.100sim.41-60 - 2025.12.03 22.39.55"
producePaceData(folder.30, df_30Node_3)
df_30Node_4 = "lowrate.30node.100sim.61-80 - 2025.12.03 22.39.58"
producePaceData(folder.30, df_30Node_4)
df_30Node_5 = "lowrate.30node.100sim.81-100 - 2025.12.03 22.40.02"
...
```{R }
runTimes.30 <- rbind(
  getRunTime(folder.30, df_30Node_1),
  getRunTime(folder.30, df_30Node_2),
  getRunTime(folder.30, df_30Node_3),
  getRunTime(folder.30, df_30Node_4),
  getRunTime(folder.30, df_30Node_5)
  )
runTimes.30
```

```{R }
runTimes.30 %>% summarise(`Run Time (mean)` = format_simtime(as.integer(mean(sysTime))), 
                       `Run Time (sd)` =  format_simtime(as.integer(sd(sysTime))))
```
